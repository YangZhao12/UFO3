...
class GalaxyClient:
    ...
    async def process_request(
        ...
        *,
        ...
        :param target_device_id: Explicit target device for direct execution
        :param direct: Bypass DAG planning for an explicitly targeted simple task
        ...
        if direct and not target_device_id:
            raise ValueError("target_device_id is required when direct=True")
        ...
        try:
            ...
            if direct:
                ...
                execution_result = (
                    await self._client.device_manager.assign_task_to_device(
                        task_id=self.task_name,
                        device_id=target_device_id,
                        task_description=request,
                        task_data={"execution_mode": "direct"},
                    )
                )
                ...
                result = {
                    ...
                    "status": (
                        "completed" if execution_result.is_successful else "failed"
                    ),
                    "mode": "direct",
                    "device_id": target_device_id,
